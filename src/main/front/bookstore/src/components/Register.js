                        ...
                        <Card.Body>
                            <Form.Row>
                                <Form.Group as={Col}>
                                    <InputGroup>
                                        <InputGroup.Prepend>
                                            <InputGroup><FontAwesomeIcon icon={faUser}/></InputGroup>
                                        </InputGroup.Prepend>
                            ...
                            <Form.Row>
                                <Form.Group as={Col}>
                                    <InputGroup>
                                        <InputGroup.Prepend>
                                            <InputGroup><FontAwesomeIcon icon={faEnvelope}/></InputGroup>
                                        </InputGroup.Prepend>
                            ...
                            <Form.Row>
                                <Form.Group as={Col}>
                                    <InputGroup>
                                        <InputGroup.Prepend>
                                            <InputGroup><FontAwesomeIcon icon={faLock}/></InputGroup>
                                        </InputGroup.Prepend>
                            ...
                            <Form.Row>
                                <Form.Group as={Col}>
                                    <InputGroup>
                                        <InputGroup.Prepend>
                                            <InputGroup><FontAwesomeIcon icon={faPhone}/></InputGroup>
                                        </InputGroup.Prepend>
